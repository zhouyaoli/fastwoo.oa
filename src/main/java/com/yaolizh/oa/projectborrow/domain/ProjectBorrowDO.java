package com.yaolizh.oa.projectborrow.domain;
 ...
 */
@Table(name="t_project_borrow")
@Entity
public class ProjectBorrowDO extends SuperBaseData {
	 ...
	 */
	private static final long serialVersionUID = 6313989784091599476L;
