...
var prefix = "/oa/projectInOutMoney"
$(function() {
	load();
});
						...
						columns : [
								{
									checkbox : true
										...
										title : '' 
																...
																{
																			field : 'type', 
										title : '交易类型(1：现金记账,2:银行记账,4:工会工行记账,8:工会贵州银行记账)' 
								},
																{
																			field : 'projectId', 
										title : '项目id' 
...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/projectInOutMoney.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
