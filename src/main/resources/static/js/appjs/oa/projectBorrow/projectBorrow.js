...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/projectBorrow.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
