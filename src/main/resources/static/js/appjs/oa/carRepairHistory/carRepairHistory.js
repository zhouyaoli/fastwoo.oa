...
var prefix = "/oa/carRepairHistory"
$(function() {
	load();
});
						...
						columns : [
								{
									checkbox : true
										...
										title : '车身颜色' 
																...
																{
																			field : 'state', 
										title : '状态(1:待维修,2:维修中,4:维修完成,8:报废)' 
								},
																{
																			field : 'reason', 
										title : '维修原因' 
...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/carRepairHistory.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
