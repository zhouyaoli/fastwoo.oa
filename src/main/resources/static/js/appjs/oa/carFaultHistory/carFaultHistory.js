						...
						columns : [
								{
									checkbox : true
										...
										title : '事故描述' 
																...
																{
																			field : 'faultSide', 
										title : '事故方(1:我方全转,2:对方全责,3：双方责任)' 
								},
																{
																			field : 'result', 
										title : '处理结果' 
...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/carFaultHistory.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
