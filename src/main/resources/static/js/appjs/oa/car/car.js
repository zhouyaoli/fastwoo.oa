						...
						columns : [
								{
									checkbox : true
										...
										title : '开始使用时间' 
																...
																{
																			field : 'carNumType', 
										title : '号牌种类(1:小型汽车号牌，2:大型汽车号牌，4:普通摩托车号牌，8:轻便摩托车号牌，16:低速车号牌，32:挂车号牌)' 
								},
																{
																			field : 'carType', 
										title : '变速箱类别（1:手动挡、2：自动档，4：手自一体）' 
								},
																{
																			field : 'carNumColor', 
										title : '车身颜色(1:黑,2:白,4:红,8:蓝)' 
								},
																{
																			field : 'bodyColor', 
										title : '车身颜色(1:黑,2:白,4:红,8:蓝)' 
										...
										title : '里程表读数' 
																...
																{
																			field : 'oilType', 
										title : '燃油种类(1:92,2:95,4:柴油:,8:纯电,16:油电混动)' 
								},
																{
																			field : 'carLen', 
										title : '整车长' 
...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/car.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
