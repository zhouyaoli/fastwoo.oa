						...
						columns : [
								{
									checkbox : true
										...
										title : '日期' 
																...
																{
																			field : 'state', 
										title : '状态(1:缺勤,2:正常，4:迟到，8:早退；16:加班,32:上午请假,64:下午请假,128:补卡)' 
								},
																{
																			field : 'workHours', 
										title : '工作时长' 
...
function importExcel() {
	layer.open({
				...
				shadeClose : false, // 点击遮罩关闭层
				area : ['400px', '220px'],
				content :  '/common/excelModel/importExcel?submitUrl='+prefix+'/saveImportExcel&modelUrl=/excelModel/oa/attend.xlsx' // iframe的url
			});
}
function edit(id) {
	layer.open({
